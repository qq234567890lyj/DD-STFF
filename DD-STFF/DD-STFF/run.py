...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='DD_STFF')
    # basic config
    parser.add_argument('--grid_size', type=int, default=5, help='status')

    parser.add_argument('--task_name', type=str, default='long_term_forecast',
                        help='task name, options:[long_term_forecast, short_term_forecast, imputation, classification, anomaly_detection]')
    parser.add_argument('--is_training', type=int, default=1, help='status')
    parser.add_argument('--model_id', type=str, default='test', help='model id')
    parser.add_argument('--model', type=str, default='DD_STFF',
                        help='model name, options: [Autoformer, Transformer, TimesNet]')
    # data loader
    parser.add_argument('--data', type=str, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Corn-Wheat.csv', help='data file')
    ...
    #  确保 look_back（历史时间步）和 look_forward（预测时间步）的值合理，不超过数据总长度。
    # 示例：若数据总长度为 T，则 look_back + look_forward <= T。
    ...
    # optimization
    parser.add_argument('--num_workers', type=int, default=4, help='data loader num workers4')
    ...
    # GNN alpha,dropout,n_heads
    parser.add_argument('--alpha', type=str, default=0.5, help='gnn type')
    parser.add_argument('--n_heads', type=int, default=4, help='num of heads in gnn')
    parser.add_argument('--dropout_gnn', type=float, default=0.5, help='dropout in gnn')
    parser.add_argument('--patch_len', type=float, default=16, help='patch_len')
    # parser.add_argument('--gnn_type', type=float, default=0.5, help='dropout in gnn')
